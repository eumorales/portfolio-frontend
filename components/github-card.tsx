...
export default function GitHubCard() {
  ...
  return (
    <Link href="https://github.com/eumorales" target="_blank" rel="noopener noreferrer">
      <div className="bg-gray-100 dark:bg-zinc-800/50 rounded-xl p-6 h-full flex flex-col cursor-pointer hover:bg-gray-200 dark:hover:bg-zinc-800/70 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg group">
          ...
          {githubStats && (
            <div className="grid grid-cols-3 gap-2 w-full">
              <div className="text-center group-hover:scale-105 transition-transform duration-300">
                <p className="text-lg font-bold text-gray-800 dark:text-gray-200">{githubStats.stars}</p>
                <p className="text-xs text-gray-600 dark:text-gray-400">Stars</p>
              </div>
              <div className="text-center group-hover:scale-105 transition-transform duration-300">
                <p className="text-lg font-bold text-gray-800 dark:text-gray-200">{githubStats.followers}</p>
                <p className="text-xs text-gray-600 dark:text-gray-400">Followers</p>
              </div>
              <div className="text-center group-hover:scale-105 transition-transform duration-300">
                <p className="text-lg font-bold text-gray-800 dark:text-gray-200">{githubStats.repos}</p>

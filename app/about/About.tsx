          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex gap-4 mb-6">
                ...
                <Link
                  href="https://instagram.com/gilbertomrls"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <AnimatedSection className="mb-12">
          ...
          <div className="space-y-4 text-gray-600 dark:text-zinc-300">
            <p>
              ...
              programming began at a young age, sparked by a curiosity to create
              plugins for games — and that passion has only grown since then.
            </p>
            <p>
              Over the years, I've developed a strong foundation in technologies
              like React, HTML, JavaScript, Python, Java, TypeScript, and more.
              My focus is on writing clean, maintainable code and designing
              scalable systems that deliver great user experiences.
            </p>
            <p>
              Outside of programming, I enjoy playing volleyball and video games
              — hobbies that keep me balanced and often inspire fresh ideas for
              my projects.
            </p>
          </div>
        </AnimatedSection>
